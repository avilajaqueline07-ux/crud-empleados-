...
<body>
<h1 style="color:yellow; background:blue"> Mi primera aplicación WEB con la tecnoligia JSP (Java Server Page)</h1>
<!--   A continuacion se agrega codigo de Java al adocumento mediante un lenguaje de marcas llamado
   scriptle -->
<%
// Comentario de uan sola linea
...
List<String> nombres =List.of("Elida","Yakelin", "Miguel","Gina","Yodalis","Youssef");
%>
